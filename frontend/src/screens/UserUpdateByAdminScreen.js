...
import { getUserDetails,updateUser } from '../features/user/userSlice'
 ...
 const UserUpdateByAdminScreen = () => {
   const params=useParams()
    ...
    },[dispatch,userLogin,params.id,userLogin.userId,navigate,userDetails.ville,userDetails.phoneNumber,userDetails.isAgence,userDetails.adresse,userDetails.nom,userDetails.prenom])
...
const submitHandler=(e)=>{
 ...
 window.location.reload()
  ...
  return <Row>
    <Col >
    <h2  className='addLine mb-5 mt-3 '>{userDetails.userName} Profile </h2>
...
export default UserUpdateByAdminScreen
